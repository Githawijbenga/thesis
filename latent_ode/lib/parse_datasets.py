...
from rumour_twitter import RumourTwitter, variable_time_collate_tweet
from rumour_twitter import RumourTwitter, get_data_min_max_tweet
...
def parse_datasets(args, device):
	...
	if dataset_name == "rumour_tweets":
		...
		train_dataloader = DataLoader(train_data, batch_size= batch_size, shuffle=False, 
			collate_fn= lambda batch: variable_time_collate_tweet(batch, args, device, data_type = "train",
				data_min = data_min, data_max = data_max))
		test_dataloader = DataLoader(test_data, batch_size = n_samples, shuffle=False, 
			collate_fn= lambda batch: variable_time_collate_tweet(batch, args, device, data_type = "test",
				data_min = data_min, data_max = data_max))
